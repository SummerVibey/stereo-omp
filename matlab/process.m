...
% matching parameters (see StereoMatcher.h for a full list)
% if you want to reproduce the middlebury results, disable subsampling,
% go to StereoMatcherMex.cpp and decomment StereoMatcher::parameters param(StereoMatcher::MIDDLEBURY);
...
try
  tic;
  [D1,D2] = StereoMatcherMex(I1',I2',param);
  time = toc;  
catch me
  disp(me.message);
  axes(aT);  cla;
