...
void mexFunction (int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[]) {
  ...
  StereoMatcher::parameters param(StereoMatcher::ROBOTICS);
  //StereoMatcher::parameters param(StereoMatcher::MIDDLEBURY);
  ...
  StereoMatcher.process(I1,I2,D1,D2,I_dims_with_bpl);
}
