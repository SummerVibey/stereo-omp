...
% MATLAB makefile for compiling the libStereoMatcher MATLAB wrappers

disp('Building wrappers ...');

% standard version
mex('StereoMatcherMex.cpp','../src/StereoMatcher.cpp','../src/descriptor.cpp', '../src/filter.cpp', ...
...
%mex('StereoMatcherMex.cpp','../src/StereoMatcher.cpp','../src/descriptor.cpp', ...
